...
This folder contains the GPR datasets used for preprocessing, depth conversion, and quantitative attribute extraction.

The data are organized according to the three investigated antenna clearances:

- `0_cm`
- `10_cm`
- `40_cm`

Each antenna-clearance folder contains the seven longitudinal survey groups (`G1`–`G7`). For each survey group, the following datasets are provided:

- **Data:** Original GPR data used as input for the processing workflow.
- **Processed:** GPR data after time-zero correction, trace alignment, dewow filtering, mean-trace removal, and T-Power gain.
- **Converted:** Processed GPR data converted from two-way travel time to depth using a constant electromagnetic wave velocity of **0.14 m/ns**.
- **Attributes:** Quantitative GPR attributes extracted from the predefined analysis windows, including the shallow construction-transition window **W1 (8–18 ns)** and deeper supporting-soil window **W3 (23–33 ns)**.

The extracted attributes include amplitude-, energy-, signal-quality-, frequency-, and spatial-coherence-based parameters used to evaluate the effects of antenna clearance and survey position.
...
<p align="center">
  <img src="02_Key_Attributes/Fig_8_W1.png" width="850" alt="Figure 8 - Statistical comparison within W1">
</p>
...
<p align="center">
  <img src="02_Key_Attributes/Fig_9_W3.png" width="850" alt="Figure 9 - Statistical comparison within W3">
</p>
...
<table>
<tr>
<td align="center"><img src="02_Key_Attributes/12a.png" width="400" alt="Figure 12a"><br><b>(a)</b> GPR — 10 cm</td>
<td align="center"><img src="02_Key_Attributes/12b.png" width="400" alt="Figure 12b"><br><b>(b)</b> GPR — 40 cm</td>
</tr>
<tr>
<td align="center"><img src="02_Key_Attributes/12c.png" width="400" alt="Figure 12c"><br><b>(c)</b> CPT-derived Vs</td>
<td align="center"><img src="02_Key_Attributes/12d.png" width="400" alt="Figure 12d"><br><b>(d)</b> CPT parameters</td>
</tr>
</table>
